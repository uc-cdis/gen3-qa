...
module.exports = {
  ...
  async generateAndAddCoremetadataNode(sheepdog) {
    console.log('Generating a core_metadata_collection record');
    ...
    const newCoremetadataNode = module.exports.getNode('core_metadata_collection').clone();
    newCoremetadataNode['data']['submitter_id'] = newSubmitterID;
    console.log('Submitting core_metadata_collection record:', newCoremetadataNode);
