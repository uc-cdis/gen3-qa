...
module.exports = {
  ...
  async submitGraphAndFileMetadata(sheepdog, nodes, fileGuid, fileSize, fileMd5, submitter_id=null, consent_codes=[]) {
    ...
    // This is done because otherwise the CCs randomly generated by the data simulator will end up here
    // and the test accounts will not have access to the files.
