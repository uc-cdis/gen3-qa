...
Scenario('Click Workspace tab when logged out and logged in @exportToWorkspacePortalGeneral @portal', async (portalExportToWorkspace, home) => {
...
Scenario('Check export to workspace success message toaster @exportToWorkspacePortalGeneral @portal', async (portalExportToWorkspace) => {
...
Scenario('Export default manifest, mount it and check manifest name @exportToWorkspacePortalJupyterHub @portal', async (portalExportToWorkspace) => {
  await portalExportToWorkspace.complete.checkExportDefaultManifestToWorkspaceJupyterHub();
});

Scenario('Export default manifest, mount it and check manifest name @exportToWorkspacePortalHatchery @portal', async (portalExportToWorkspace) => {
