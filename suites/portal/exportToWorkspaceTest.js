...
Scenario('Click Workspace tab when logged out and logged in @exportToWorkspacePortalGeneral', async (portalExportToWorkspace, home) => {
...
Scenario('Check export to workspace success message toaster @exportToWorkspacePortalGeneral', async (portalExportToWorkspace) => {
...
Scenario('Export default manifest, mount it and check manifest name @exportToWorkspacePortalJupyterHub', async (portalExportToWorkspace) => {
  await portalExportToWorkspace.complete.checkExportDefaultManifestToWorkspaceJupyterHub();
});

Scenario('Export default manifest, mount it and check manifest name @exportToWorkspacePortalHatchery', async (portalExportToWorkspace) => {
