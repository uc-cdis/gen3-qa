...
Scenario('Check export to workspace success message toaster @exportToWorkspace', async (portalExportToWorkspace) => {
...
Scenario('Export default manifest, mount it and check manifest name @exportToWorkspace', async (portalExportToWorkspace, exportToWorkspaceUtil) => {
  await portalExportToWorkspace.complete.checkExportDefaultManifestToWorkspace(exportToWorkspaceUtil);
});
