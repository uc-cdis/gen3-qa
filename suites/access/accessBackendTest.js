...
// GUI Testing
xScenario('Super Admin: login + edit Admin. @manual', ifInteractive(
  async ({ I }) => {
...
xScenario('Super Admin: login + add Admin. @manual', ifInteractive(
  async ({ I }) => {
    if (!I.cache.ACCESS_TOKEN) I.cache.ACCESS_TOKEN = await requestUserInput('Please provide your ACCESS_TOKEN: ');
    const accessTokenJson = parseJwt(I.cache.ACCESS_TOKEN);
...
xScenario('Super Admin: export TSV. @manual', ifInteractive(
  async () => {
    const result = await interactive(`
...
// Admin GUI Testing
xScenario('Admin: login + add user. @manual', ifInteractive(
  async ({ I }) => {
...
// Admin GUI Testing
xScenario('Admin: login again + edit and delete user. @manual', ifInteractive(
  async ({ I }) => {
...
xScenario('Super Admin: delete Admin user. @manual', ifInteractive(
  async ({ I }) => {
    if (!I.cache.ACCESS_TOKEN) I.cache.ACCESS_TOKEN = await requestUserInput('Please provide your ACCESS_TOKEN: ');
    const accessTokenJson = parseJwt(I.cache.ACCESS_TOKEN);
