...
async function runLoadTestScenario() {
    ...
    spawn('k6', ['run', '-e', `GEN3_HOST=${target_environment}`, '-e', `ACCESS_TOKEN=${token}`, '--out', 'influxdb=http://localhost:8086/db0', `suites/load-testing/${target_service}/${load_test_scenario}.js`], { stdio: 'inherit' } ); 
    // spawn('pwd', [] , { stdio: 'inherit' } );
    // run --out influxdb=http://localhost:8086/db0 suites/fence/presigned-url.js
    }
