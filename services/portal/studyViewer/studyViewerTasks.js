...
module.exports = {
  ...
  goToStudyViewerPage() {
    ...
    I.waitForVisible(studyViewerProps.studyViewerDivClass, ); // .study-viewer
    I.wait(5)
  ...
  //   I.amOnPage(studyViewerProps.dataset1Path);
  //   I.wait(10);
  //   I.saveScreenshot('dataset_page.png');
  //   I.waitForVisible(studyViewerProps.datasetDivClass, 20);
  // },
