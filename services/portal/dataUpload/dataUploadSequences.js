...
module.exports = {
  ...
  checkUnmappedFilesAreNotInFileMappingPage(fileObjects) {
    ...
    dataUploadQuestions.cannotSeeUnmappedFilesOnPage(unexpectedFileNames);
  },
  ...
  async checkCouldMapFiles(fileObjects) {
    ...
    dataUploadTasks.fillAllRequireFields();
