...
module.exports = {
  ...
  async forceLinkGoogleAcct(userAcct, googleEmail) {
    ...
    console.dir(`#### force link access token : ${userAcct.accessTokenHeader.Authorization}`);
    console.dir(`#### force link useracct : ${userAcct.username}`);
